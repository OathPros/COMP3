...
Text fields are used for single line text entry and editing. :doc:`Search entries </patterns/nav/search>` are a type of text field which have their own dedicated pattern.
...
* Icons, to provide additional information, such as a :doc:`progress spinner </patterns/feedback/spinners>`.
