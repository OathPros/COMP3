...
Info bars are more permanent than :doc:`notifications <notifications>` and :doc:`toasts <toasts>`. This makes them appropriate for communicating ongoing states which the user needs to be aware of, or location-specific information.
...
* `GTK 3: GtkInfoBar <https://docs.gtk.org/gtk3/class.InfoBar.html>`_
