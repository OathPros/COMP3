...
Toasts can be used to show messages and offer actions in response to user interaction with an app. One common use for toasts is to show an undo button after a destruction action.
