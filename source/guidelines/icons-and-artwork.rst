...
Two styles of icon are used in GNOME 3: full-color and symbolic icons.
...
GNOME provides a set of standard icons, which can be used by applications. This can be accessed directly through GTK. Icon names follow the `Freedesktop icon specification <https://standards.freedesktop.org/icon-naming-spec/icon-naming-spec-latest.html>`_. Symbolic versions of icons have the ``-symbolic`` name ending, such as ``open-menu-symbolic``.

The :doc:`icon design guidelines </guidelines/icon-design>` provide more details on how to create your own icons, including application icons.
