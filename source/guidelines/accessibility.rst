...
There are a number of quick and easy ways to check whether your application is accessible, and these are described in the relevant pages of the HIG. The following list brings these tests together for convenience.

In each case, test to ensure that your application works correctly with accessibility features, including:
...
* Keyboard navigation. Use the app using only the keyboard. Can every part of the application be navigated to and interacted with? Does the UI follow the :ref:`keyboard navigation guidelines <keyboard-nav>`?
