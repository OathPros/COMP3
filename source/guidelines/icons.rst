...
Application icons are the exception to this rule. Applications should have thier own unique icon, and should never reuse an existing one. The :doc:`icon design guidelines <icon-design>` provide more details on how to create your own icons, including application icons.
