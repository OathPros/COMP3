...
Utility panes are vertical panels which are shown on one side of a window. They have some similarities with :doc:`sidebars </nav/sidebars>`, but play a different role and behavior.
